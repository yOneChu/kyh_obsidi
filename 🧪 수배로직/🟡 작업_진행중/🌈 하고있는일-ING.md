...
**| 해야할 일**
- 4월 BOM COP 활동보고서 작성하기(~4/28)
- RAIL BRACKET은 어떻게 수배되는가?
- 루젠-G 수배자료 전산화 (PIT SCREEN)
- 


**| 진행 중 업무**
1. 최초설계완료BOM 이력 쌓기
	- 호기집계완료 : 2026.01~2026.03
	- BOM 집계 완료 : 2026.01
2. 로직 비교 기능
...
**| 전산작업요청 건 이슈**
- 03268
	- 이창희부장님한테 문의 -> 형상이 아예다른데 1:1매칭으로 바꿀수가 없다. 어떻게해야되냐?
