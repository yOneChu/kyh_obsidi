...
SELECT  
       ...
       V.EL_DACAPA AS EL_DACAPA, --(교체전)용량  
       V.EL_DAFQ AS EL_DAFQ, --(교체전)층수  
       V.EL_DAMAN AS EL_DAMAN, --(교체전)인승  
       ...
       V.EL_ECCH AS EL_ECCH, --CAR 높이; CH  
       COD(V.EL_ECDOP) AS EL_ECDOP , --◎ CAR DOOR OPER  
       V.EL_ECEE AS EL_ECEE, --CAR 무게중심;EE  
       COD(V.EL_ECGP) AS EL_ECGP, -- ◎ CAR : GOVERNOR 위치  
       COD(V.EL_ECGV) AS EL_ECGV, --    CAR; GOVERNOR  
       COD(V.EL_ECGSH) AS EL_ECGSH, -- CAR; GUIDE SHOE  
       V.EL_ECHH AS EL_ECHH, -- 도어높이;HH  
       V.EL_ECHOR AS EL_ECHOR, --  CAR중심 가로  
       ...
       COD(V.EL_ECWTP) AS EL_ECWTP, -- CWT_위치  
       COD(V.EL_ECWBUF) AS EL_ECWBUF, -- CWT; BUFFER  
       V.EL_ECWBUFBH AS EL_ECWBUFBH, --CWT BUFFER BLOCKING 높이  
       V.EL_ECBG AS EL_ECBG, --CAR:BG  
       V.EL_ECJJ AS EL_ECJJ, --도어폭;JJ  
       COD(V.EL_ECRL) AS EL_ECRL, -- CAR RAIL(K)  
       V.EL_ECSD AS EL_ECSD, -- ◎ CAR;SHEAVE DIA  
        COD(V.EL_ECSF) AS EL_ECSF, -- CAR; SAFETY  
        V.EL_ECSL AS EL_ECSL, --◎ 적용하중 (CAR)        
        V.EL_ECSQ AS EL_ECSQ, --◎ CAR;SHEAVE QTY  
        V.EL_ECVER AS EL_ECVER, -- CAR중심 세로  
        V.EL_ECW AS EL_ECW, -- CAR자중  
       ...
       V.EL_ECWSQ AS EL_ECWSQ, --  ◎ CWT;SHEAVE QTY  
       ...
       V.EL_EHH AS EL_EHH, --    승강로 가로;XX  
       V.EL_EHJH AS EL_EHJH, --  ◎ LADDER; JH  
       COD(V.EL_EHM) AS EL_EHM, --    승강로 재질  
       V.EL_EHO AS EL_EHO, --    승강로 OVERHEAD       
       V.EL_EHP AS EL_EHP, --    승강로 PIT       
       V.EL_EHTH AS EL_EHTH, --  승강로 전장; TOTAL HEIGHT  
       V.EL_EHTRH AS EL_EHTRH, --주행거리  
       V.EL_EHV AS EL_EHV, --승강로 세로;YY  
       V.EL_ELADHH AS EL_ELADHH, --  ◎ LADDER; HH  
       V.EL_ELADRD AS EL_ELADRD, --  ◎ LADDER; RD  
       ...
       V.EL_EPP AS EL_EPP, --  ◎ ROPE;PP(로프거리)  
       V.EL_EPPX AS EL_EPPX, --    ROPE ; X 가로  
       V.EL_EPPY AS EL_EPPY, -- ROPE ; Y 가로  
       V.EL_EPSRD AS EL_EPSRD, --  ◎ PIT SCREEN;RD  
       COD(V.EL_ERB) AS EL_ERB, -- ◎ RAIL BRKT;TYPE  
       V.EL_ERBH AS EL_ERBH, --    RAIL BRACKET 간격  
       ...
       CODN(V.EL_ETHRUTY) AS EL_ETHRUTY, --  ◎ 관통 타입  
       V.EL_ETMINV AS EL_ETMINV, --    INVERTER용량  
       V.EL_ETMM AS EL_ETMM, --    MOTOR용량  
       V.EL_EWM1 AS EL_EWM1, --    ◎ WALL ; 후면중앙  
